...
import { Eye, Loader2, RefreshCw, Calendar, UserPlus } from 'lucide-react';
...
export function BulkReferTab() {
  ...
  const loadReferralHistory = async () => {
    ...
    try {
      let query = supabase
        ...
        .in('activity_type', ['ownership_transferred', 'lead_referred'])
  ...
  const handleViewDetails = (record: ReferralRecord) => {
      ...
      <div className="flex-1 overflow-auto p-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <h3 className="text-lg font-medium text-slate-900 mb-2">No Referral History</h3>
            <p className="text-slate-600">
              No bulk referrals found for the selected filters.
            </p>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-slate-600">Referred By</label>
                ...
                <div>
                  <label className="text-sm font-medium text-slate-600">Leads Affected</label>
                  <p className="text-slate-900 mt-1">{selectedRecord.affected_leads_count || 1}</p>
                </div>
              </div>
            </div>
